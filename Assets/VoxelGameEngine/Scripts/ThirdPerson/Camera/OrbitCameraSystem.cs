...
namespace VoxelGameEngine.ThirdPerson
{
    ...
    public partial struct OrbitCameraSimulationSystem : ISystem
    {
        ...
        {
            state.RequireForUpdate(SystemAPI.QueryBuilder().WithAll<OrbitCameraComponent, OrbitCameraControlComponent>().Build());
        }
        ...
        public partial struct OrbitCameraSimulationJob : IJobEntity
        {
            ...
            void Execute(Entity entity, ref OrbitCameraComponent orbitCamera, in OrbitCameraControlComponent cameraControl)
            {
    ...
    public partial struct OrbitCameraLateUpdateSystem : ISystem
    {
        ...
        public partial struct OrbitCameraLateUpdateJob : IJobEntity
        {
            ...
            [ReadOnly]
            public ComponentLookup<CameraTargetComponent> CameraTargetLookup;
            [ReadOnly]
            ...
            void Execute(
                ...
                in OrbitCameraControlComponent cameraControl,
